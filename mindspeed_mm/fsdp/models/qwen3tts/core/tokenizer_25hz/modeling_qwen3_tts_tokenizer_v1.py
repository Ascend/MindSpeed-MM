...
class UpSample1d(nn.Module):
    def __init__(self, ratio=2, kernel_size=None):
        ...
        filter1d = kaiser_sinc_filter1d(cutoff=0.5 / ratio, half_width=0.6 / ratio, kernel_size=self.kernel_size)
        self.register_buffer("filter", filter1d, persistent=False)
...
class DownSample1d(nn.Module):
    def __init__(self, ratio=2, kernel_size=None):
        ...
        self.stride = ratio
        filter1d = kaiser_sinc_filter1d(cutoff, half_width, kernel_size)
        self.register_buffer("filter", filter1d, persistent=False)
...
class Qwen3TTSTokenizerV1DecoderDiTModel(Qwen3TTSTokenizerV1DecoderPreTrainedModel):
    ...
    def sample(
        ...
        noise_initialization = torch.randn([quantized_code.shape[0], 30000, self.mel_dim],
