...
class KimiK_3_MoeRMSNormGated(nn.Module):
    def __init__(self, hidden_size, eps=1e-6, **kwargs):
        ...
        if IS_NPU_AVAILABLE:
            print(logger.info, "KimiK_3_MoeRMSNormGated use NPU fused ops")
    ...
    def forward(self, hidden_states, gate=None):
        ...
        if IS_NPU_AVAILABLE:
            ...
            hidden_states = hidden_states * F.sigmoid(gate.to(torch.float32)).to(input_dtype)
...
class KimiDeltaAttention(nn.Module):
    def __init__(self, config: KimiLinearConfig, layer_idx: int):
        ...
        self.o_norm = KimiK_3_MoeRMSNormGated(
...
class KimiLinearForCausalLM(KimiPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        # unified logits/loss computation, enabling MindSpeed-MM chunk loss.
        # The VLM wrapper (KimiK3ForConditionalGeneration) will apply lm_head.
