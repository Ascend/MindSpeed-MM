...
def eager_permute(tokens, indices, num_out_tokens=None):
...
def fused_permute(tokens, indices, num_out_tokens=None):
    return torch_npu.npu_moe_token_permute(tokens, indices, num_out_tokens=num_out_tokens)
