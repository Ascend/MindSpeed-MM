...
class GenerationMixin:
    ...
    def generate(
        ...
        if generation_config.pad_token_id is None and generation_config.eos_token_id is not None:
            ...
            logger.warning(
                "Setting `pad_token_id` to `eos_token_id`: %s for open-end generation.",
                eos_token_id
            )
        ...
        if generation_config.max_new_tokens is not None:
            if not has_default_max_length and generation_config.max_length is not None:
                logger.warning(
                    "Both `max_new_tokens` (= %s) and `max_length` (= %s) seem to have been set. `max_new_tokens` will take precedence. "
        ...
        if generation_mode == GenerationMode.SAMPLE:
            ...
            raise NotImplementedError("other generation modes not implemented")
