...
MM_DATA="$BASEPATH/tests/st/run_configs/finetune_qwen3vl_30B/data_30B.json"
MM_MODEL="$BASEPATH/tests/st/run_configs/finetune_qwen3vl_30B/model_30B.json"
...
torchrun $DISTRIBUTED_ARGS \
    $BASEPATH/pretrain_transformers.py \
    $GPT_ARGS \
    $MM_ARGS \
    $OUTPUT_ARGS \
