...
class VppParallelConfig(BaseModel):
    ...
    """llm模块pipeline parallel切分每张卡上切分几层, vpp切分配置参考docs/zh/features/parallel/virtual_pipeline_parallel.md"""

    vit_pp_layers: List[List[NonNegativeInt]]
    """vit模块pipeline parallel切分每张卡上切分几层, vpp切分配置参考docs/zh/features/parallel/virtual_pipeline_parallel.md"""

    audio_pp_layers: Optional[List[List[NonNegativeInt]]] = None
    """audio模块pipeline parallel切分每张卡上切分几层, vpp切分配置参考docs/zh/features/parallel/virtual_pipeline_parallel.md"""
