...
<p align="center">
    <a href="https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/LICENSE">
    <a href="https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/LICENSE">
...
📈未来规划会动态刷新在[MindSpeed MM RoadMap](https://gitcode.com/Ascend/MindSpeed-MM/issues/176)中，欢迎社区通过此链接进行互动并提出诉求
...
* **[Sep. 03, 2025]: 🎉 强化学习上线！ MindSpeed MM支持Qwen2.5VL 7B/32B [GRPO训练](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/examples/verl_examples/qwen2.5vl/README.md)**
...
更多详情请参考[版本配套表](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/user-guide/installation.md#%E7%89%88%E6%9C%AC%E9%85%8D%E5%A5%97%E8%A1%A8)。

# 安装

---

MindSpeed MM具体的安装请参考[安装指南](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/user-guide/installation.md#%E5%AE%89%E8%A3%85%E6%8C%87%E5%8D%97)。

# 快速上手

---

MindSpeed MM将以Qwen2.5-VL-3B和Wan2.1-T2V-1.3B模型为例，引导开发者快速上手预置模型在昇腾NPU上的高效运行。具体的操作请参考[快速上手](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/user-guide/getting_start.md#%E5%BF%AB%E9%80%9F%E4%B8%8A%E6%89%8B)。
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <tr>
      <td><a href="https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/examples/lumina">Lumina-mGPT 2.0</a></td>
      ...
      <tr>
      <td><a href="https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/examples/opensoraplan1.5/">OpenSoraPlan1.5</a></td>
...
针对MindSpeed MM套件中运行所使用的参数做解释说明，具体见[README](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/user-guide/args_readme.md)
...
[MindSpeed MM 安全声明](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/SECURITYNOTE.md)
