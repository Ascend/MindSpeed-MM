...
更多详情请参考[版本配套表](/docs/zh/release_notes_mm.md#产品版本信息)。

# 安装

---

MindSpeed MM具体的安装请参考[安装指导](/docs/zh/pytorch/install_guide.md)。
当前qwen3vl、wan2.2模型已支持一键安装，一键安装使用说明详见[一键安装使用说明](/docs/zh/pytorch/install_guide.md#一键安装)。

# 快速上手

---

MindSpeed MM将以Qwen2.5-VL-3B和Wan2.1-T2V-1.3B模型为例，引导开发者快速上手预置模型在昇腾NPU上的高效运行。具体的操作请参考[快速入门](docs/zh/pytorch/quickstart.md)。
