...
大语言模型（稠密模型、稀疏模型和状态空间模型）由MindSpeed-LLM专项维护，如果需要进行大语言模型的训练，请访问大语言模型仓库获取详细的使用说明：[MindSpeed-LLM](https://gitcode.com/Ascend/MindSpeed-LLM/blob/master/docs/zh/pytorch/models/supported_models.md)。
