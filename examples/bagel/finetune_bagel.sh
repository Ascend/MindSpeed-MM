...
MM_DATA="./examples/bagel/data.json"
MM_MODEL="./examples/bagel/model.json"
...
GPT_ARGS="
    ...
    --fsdp2-config-path examples/bagel/fsdp2_config.yaml \
...
mkdir -p logs
torchrun $DISTRIBUTED_ARGS pretrain_omni.py \
    $GPT_ARGS \
    $MM_ARGS \
    $OUTPUT_ARGS \
