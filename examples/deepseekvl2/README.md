...
1. DeepSeekVL2权重转换依赖deepseekvl2包，安装过程参考[链接](https://github.com/deepseek-ai/DeepSeek-VL2)。deepseekvl2包与特定版本的transformers兼容，建议安装transformers 4.45.0或transformers 4.38.2版本以确保兼容性。
