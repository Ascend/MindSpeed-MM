...
MM_DATA="./examples/wan2.2/A14B/i2v/data.json"
MM_MODEL="./examples/wan2.2/A14B/i2v/pretrain_model_high.json"
...
logfile=wan_$(date +%Y%m%d)_$(date +%H%M%S)
mkdir -p logs
...
# ========train low noised model========

MM_DATA="./examples/wan2.2/A14B/i2v/data.json"
MM_MODEL="./examples/wan2.2/A14B/i2v/pretrain_model_low.json"
MM_TOOL="./mindspeed_mm/tools/tools.json"
LOAD_PATH="./weights/Wan-AI/Wan2.2-I2V-A14B-Diffusers/transformer_2/"  # ensure the wandit weight be converted
