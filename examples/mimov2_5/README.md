...
请参考[安装指南](https://gitcode.com/Ascend/MindSpeed-MM/tree/26.1.0/docs/zh/pytorch/install_guide.md)，完成昇腾软件安装。
...
```bash
bash scripts/install.sh --msbranch 26.1.0_core_r0.12.1 && pip install transformers==5.2.0 accelerate==1.2.0
```
