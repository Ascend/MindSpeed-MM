...
MM_DATA="./examples/lumina/mgpt2/feature_data.json"
MM_MODEL="./examples/lumina/mgpt2/model.json"
MM_TOOL="./mindspeed_mm/tools/tools.json"
LOAD_PATH="./Lumina/Lumina-mGPT-2.0-mm-convert/"
SAVE_PATH="./lumina_mgpt2_ckpt"
...
mkdir -p logs
torchrun $DISTRIBUTED_ARGS pretrain_lumina.py \
    $GPT_ARGS \
    $MM_ARGS \
    $OUTPUT_ARGS \
