...
MM_DATA="./examples/magistral-2509/data.json"
MM_MODEL="./examples/magistral-2509/model.json"
MM_TOOL="./mindspeed_mm/tools/tools.json"
LOAD_PATH="./ckpt/convert_path/Magistral-Small-2509-lora-base"
SAVE_PATH="./Magistral-Small-2509_lora_finetune_result"
FSDP2_PATH="./examples/magistral-2509/fsdp2_lora_config.yaml"
...
# GPT_ARGS中模型相关参数具体配置在examples/magistral-2509/model.json中，训练相关参数配置在这里
GPT_ARGS="
    --use-mcore-models \
