...
MM_DATA="./examples/mindspore/wan2.1/1.3b/i2v/feature_data.json"
MM_MODEL="./examples/mindspore/wan2.1/1.3b/i2v/pretrain_model.json"
MM_TOOL="./mindspeed_mm/tools/tools.json"
LOAD_PATH="path to load your wandit weight"
SAVE_PATH="path to save your wandit weight"
layerzero_config="examples/mindspore/wan2.1/zero_config.yaml"
