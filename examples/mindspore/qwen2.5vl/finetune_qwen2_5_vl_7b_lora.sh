...
#  The specific configuration of model-related hyperparameters in GPT_ARGS is located in example/mindspore/qwen2.5vl/model_7b.json
#  The training-related hyperparameters are configured here
GPT_ARGS="
    --use-mcore-models \
