...
HOSTFILE="examples/mindspore/internvl2.5/hostfile.txt"
...
MM_DATA="./examples/mindspore/internvl2.5/data_78B.json"
MM_MODEL="./examples/mindspore/internvl2.5/model_78B.json"
