...
MASTER_PORT=6000
NNODES=16 # qwen3vl 235B模型需要16机A3运行，可参考readme介绍配置多机训练
NODE_RANK=0
WORLD_SIZE=$(($NPUS_PER_NODE*$NNODES))

MM_DATA="./examples/qwen3vl/data_235B.json"
MM_MODEL="./examples/qwen3vl/model_235B.json"
MM_TOOL="./mindspeed_mm/tools/tools.json"
LOAD_PATH="ckpt/mm_path/Qwen3-VL-235B-Instruct"
SAVE_PATH="save_dir"
...
# GPT_ARGS中模型相关参数具体配置在example/qwen3vl/model_xb.json中，训练相关参数配置在这里
GPT_ARGS="
    --use-mcore-models \
