...
`mm-convert`工具详细用法参考[权重转换工具](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/features/权重转换工具.md)。
...
开启VPP需要添加以下参数（N为VPP切分数），特性说明[参考](https://gitcode.com/Ascend/MindSpeed-MM/blob/2.3.0/docs/features/virtual_pipeline_parallel.md)：
```shell
