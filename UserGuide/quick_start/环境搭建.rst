...
环境要求
------------
- **基础设施**: 当前支持昇腾A2、A3、Ascend 950 系列产品
...
下载 `TorchNPU <https://www.hiascend.com/developer/download/community/result?module=pt>`_ ，参考 `TorchNPU 配置与安装 <https://www.hiascend.com/document/detail/zh/Pytorch/730/configandinstg/instg/insg_0004.html>`_ 或执行以下命令安装：

安装torch和TorchNPU，以下以python 3.10 + torch 2.7.1为例：
