...
1. 基于PyTorch框架和Python3.12完成模型训练环境的安装，具体请参见[MindSpeed MM安装指导](../installation/install_guide.md)。
...
3. 权重转换
    ...
    **表 1** 权重转换工具参数解析
    ...
    > [!NOTE]
    > 由于Qwen2_5_VL和Qwen2_VL在权重转换逻辑上保持一致，更多工具详情可参见[权重转换命令行工具](../../tools/mm_convert.md)。
