...
套件支持FSDP2特性，可以参考 [FSDP2使用说明](../../features/parallel/fsdp2.md) 使用FSDP2。
...
具体特性参考 [官方文档](https://docs.pytorch.org/docs/stable/distributed.fsdp.fully_shard.html#torch.distributed.fsdp.CPUOffloadPolicy)
...
对于FSDP2模型，重计算在yaml中配置生效，使用方法参考 [FSDP2使用说明](../../features/parallel/fsdp2.md) 使用
...
已经有一些研究提供了一些建议，下面引述 [USP论文](https://arxiv.org/pdf/2405.07719) 中的一些观点，详细分析见论文原文。
