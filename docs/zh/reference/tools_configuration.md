...
在模型config设置里开启enable采集开关，设置profile_type 为 static，设置ranks
...
当config_path指向空文件夹会自动生成profiler_config.json文件，
在模型运行过程中，随时修改profiler_config.json文件配置，profiling采集会在下一个step生效并开启，
profiler_config.json 配置当时可以参考：[采集并解析性能数据（dynamic_profile）](https://www.hiascend.com/document/detail/zh/CANNCommunityEdition/800alpha001/devaids/devtools/profiling/atlasprofiling_16_0033.html#ZH-CN_TOPIC_0000002046667974__section17272160135118)
