...
各配置段的字段含义，可参考示例配置 `examples/qwen3_5/qwen3_5_4B_config.yaml`，以及 [FSDP2 开发者迁移指南](../../guides/development/fsdp2_model_migration_guide.md)。
...
训练后导出 HF 权重（`dcp_to_hf`）、完整参数说明，以及个别模型的专用转换器，详见[权重转换](../../tools/mm_convert.md)。
