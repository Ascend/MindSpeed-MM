...
1. 参考[MindSpeed MM安装指导](../../guides/installation/install_guide.md)，完成环境安装。
...
4. 数据集下载（以COCO2017数据集为例）
    ...
    运行数据转换脚本python mindspeed_mm/fsdp/tools/data_tool/llava_instruct_2_mllm_demo_format.py，转换后参考数据目录结构如下：
