...
配置文件主要包括模型配置 (model.json)、数据配置 (data.json)、FSDP2 配置 (fsdp2.yaml)，配置文件内容可以参考 [配置说明](https://mindspeed-mm.readthedocs.io/zh-cn/latest/config/%E9%85%8D%E7%BD%AE%E6%A6%82%E8%A7%88.html)，这里 Diffusion、AE 和 text_encoder 使用 Wan2.2 的模型。
