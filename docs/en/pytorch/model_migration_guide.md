...
Refer to [Installation Guide](install_guide.md) to install Ascend software.

>[!NOTE]
>
> It is recommended to use Python 3.10, along with torch and TorchNPU 2.7.1.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>-</td>
      <td>        
        <code>true</code>: ZeRO3 (memory-saving)<br>
